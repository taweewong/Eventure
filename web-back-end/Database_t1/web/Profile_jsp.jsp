        ...
        <div class="container">
            ...
            <div class="wrapper center-block">
                ...
                <div class="col-lg-6 col-xs-12" id="right">
                    ...
                    <form action="Update_profile_Servlet" method="POST" enctype="multipart/form-data" id="edit_form">
                        <h4>First name : </h4>
                        ...
                        <h4>Gender :</h4>
                        <select class="selectpicker" name="gender" title="Select gender" form="edit_form" required>
