 ...
 * @author Taweewong
 */
@WebServlet(name = "Check_join_no_app_Servlet", urlPatterns = {"/Check_join_no_app_Servlet"})
public class Check_join_no_app_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                String sql = "INSERT INTO reserve VALUES('" + user_id + "','" + event.getEvent_id() + "','" + localDate + "','" + 1 + "')";
