 ...
 * @author Sea
 */
@WebServlet(name = "My_event_Servlet", urlPatterns = {"/My_event_Servlet"})
public class My_event_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("my_event.jsp");
